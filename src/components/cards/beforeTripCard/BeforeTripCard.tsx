  ...
  return (
    <div className={`card before-trip-card ${className}`}>
      <div className="card-content">
        <h2 className="card-title">{t("beforeTrip.title")}</h2>
        <p >{t("beforeTrip.equipment.intro")}</p>
        <div className="protective-gear--wrapper">
          <div className="protective-gear--card">
            <Helmet className="protective-gear--icon" />
            <p className="protective-gear--text">{t("beforeTrip.equipment.helmet")}</p>
          </div>
          <div className="protective-gear--card">
            <Armor className="protective-gear--icon" />
            <p className="protective-gear--text">{t("beforeTrip.equipment.armor")}</p>
          </div>
          <div className="protective-gear--card">
            <Gloves className="protective-gear--icon" />
            <p className="protective-gear--text">{t("beforeTrip.equipment.gloves")}</p>
          </div>
          <div className="protective-gear--card">
            <Boots className="protective-gear--icon" />
            <p className="protective-gear--text">{t("beforeTrip.equipment.boots")}</p>
          </div>
        </div>
        <p>
          {t("beforeTrip.equipment.bootsDisclaimer")}
        </p>
        <p>{t("beforeTrip.closingText")}</p>
      </div>
    </div>
  );
}
